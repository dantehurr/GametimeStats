      ...
      value(...args) {
        ...
        if (!instance) {
          hostRef.$onReadyPromise$.then((instance2) => {
            var _a2;
            return (_a2 = instance2[cbName]) === null || _a2 === void 0 ? void 0 : _a2.call(instance2, ...args);
          });
        } else {
    ...
    if (BUILD.style && Cstr.style) {
      ...
      if (!styles.has(scopeId2)) {
        ...
        BUILD.shadowDomShim && cmpMeta.$flags$ & 8) {
          style = await import("./shadow-css-FPDHSH4D.js").then((m) => m.scopeCss(style, scopeId2, false));
        }
...
*/
//# sourceMappingURL=chunk-Y5SBYP7J.js.map
